...
class GPS_IDX:
    ...
    GPS_NUMBER_OF_SV = const(5)
    GPS_GNSS_WEEK = const(6)
    GPS_GNSS_TOW = const(7)
    GPS_LATITUDE = const(8)
    GPS_LONGITUDE = const(9)
    GPS_ELLIPSOID_ALT = const(10)
    GPS_MEAN_SEA_LVL_ALT = const(11)
    GPS_GDOP = const(12)
    GPS_PDOP = const(13)
    GPS_HDOP = const(14)
    GPS_VDOP = const(15)
    ...
    GPS_ECEF_Y = const(18)
    GPS_ECEF_Z = const(19)
    GPS_ECEF_VX = const(20)
    GPS_ECEF_VY = const(21)
    GPS_ECEF_VZ = const(22)
